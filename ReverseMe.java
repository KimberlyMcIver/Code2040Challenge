...
public class ReverseMe {
    ...
    // Initializing empty string container as global variable for reverseString Method.
    ...
    // Receive string from API's post endpoint
    ...
    private static String receiveInfo() throws IOException {
     ...
     // Reverse the given string from API
